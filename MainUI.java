...
public class MainUI {
    ...
    private void createAndShowGUI() {
        ...
        runButton.addActionListener(e -> {
            ...
            new Thread(() -> {
                int[] arr = SortManager.generateRandomArray(size);
                java.util.List<SortResult> results = SortManager.runAllSorts(arr);
                ...
                for (int i = 0; i < results.size(); i++) {
                    ...
                    data[i][1] = (r.timeTakenNs / 1_000_000) + " ms";
    ...
    static class ChartPanel extends JPanel {
        private final String[] algorithms = {
                ...
                "Insertion Sort", "Heap Sort", "Counting Sort", "Radix Sort"
        };
        private int[] times = new int[algorithms.length];

        public void setTimes(int[] times) {
            if (times.length == algorithms.length) {
                this.times = times;
            }
        }
    ...
    static class SwapChartPanel extends JPanel {
        ...
        private int[] swaps = new int[algorithms.length];

        public void setSwaps(int[] swaps) {
            if (swaps.length == algorithms.length) {
                this.swaps = swaps;
            }
        }
